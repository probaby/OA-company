...
<head>
	...
	function turnPage(p){
		window.location.href="userAction_getMyApp.action?page="+p;
	}
    </script>
        ...
        <tbody id="TableData" class="dataContainer" datakey="userList">
         ...
         <div class="info">
            ...
            <tr class="TableDetail1 template">
                ...
                <c:if test="${list.applicationDeal==1}">
              	  未处理
                
                
                </c:if>
                     <c:if test="${list.applicationDeal==2}">
                	不通过
                
                
                </c:if>
                        <c:if test="${list.applicationDeal==3}">
                	通过
                
                
                </c:if>
                </td>
                <td>${list.applicationStep}&nbsp;</td>
				<td>${list.allCount}&nbsp;</td>
