...
<head>
	...
	function turnPage(p){
		window.location.href="userAction_getAllUser.action?page="+p;
	}
    </script>
        ...
        <tbody id="TableData" class="dataContainer" datakey="userList">
         ...
         <div class="info">
            ...
            <tr class="TableDetail1 template">
                ...
                <td width="160px"><a onClick="return window.confirm('您确定要删除用户吗？')" href="userAction_delUser.action?deltools=${list.userName}">删除</a></br></br>
